...
export const Footer = () => {
    return (
        <div className="bg-brand-app-orange flex w-full flex-col items-center px-6 py-20 md:px-12 lg:px-20 xl:px-32">
            <div className="font-chillax text-4xl font-bold md:text-5xl xl:text-6xl">See ya blockbiterz!</div>
